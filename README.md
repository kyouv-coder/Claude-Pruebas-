...
- **Vencimiento de giftcard sin forma de cargarlo (corregido)**: la giftcard ya tenía el campo `expiresAt` en la base, se mostraba en `/admin/giftcards`, y hasta existía la recomendación "giftcards por vencer" en el dashboard — pero no había ningún campo en el formulario de venta para cargar una fecha, así que siempre quedaba vacío y esa alerta nunca podía dispararse. Ahora "Vender giftcard" en Caja tiene un campo opcional de vencimiento.
