...
```bash
export SENTRY_API=".claude/skills/sentry/scripts/sentry_api.py"
```

This is a project-scoped skill, installed at `.claude/skills/sentry/` in this repo (not the user-home `$AGENT_SKILLS_HOME` layout from the upstream catalog).
